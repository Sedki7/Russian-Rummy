...
export default function Game() {
    ...
    const toggleTimer = () => {
        ...
        setGameState((prevState) => {
            ...
            return {
                ...prevState,
                isPlaying: !prevState.isPaused ? !prevState.isPlaying : true,
                isPaused: prevState.isPlaying ? !prevState.isPaused : false,
            };
        });
    };
        ...
        <div className="min-h-screen p-4">
            <div className="max-w-md mx-auto space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <Button
                        onClick={nextPlayer}
                        className="h-16 text-sm font-semibold bg-blue-600 hover:bg-blue-700"
                    >
